...
execute store success score #t0 _flow_internal.register run summon interaction 0 0 0 {UUID:[I;-561153760,-1190705069,-1281177796,-1328175027],width:0,height:0}
...
execute store success score #t0 _flow_internal.register run summon interaction 0 0 0 {UUID:[I;1784081446, -71480548, -1480631848, -1613413280],width:0,height:0}
