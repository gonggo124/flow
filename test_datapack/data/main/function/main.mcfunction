...
execute as 6a56ec26-fbbd-4b1c-a7bf-59d89fd54460 on vehicle on passengers if entity @s[tag=_flow_internal.stack.bit,type=marker] run scoreboard players operation #r1 _flow_internal.register = @s _flow_internal.stack
